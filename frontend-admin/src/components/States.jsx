 ...
 *
 * The API base URL is printed on failure on purpose: the most likely cause is a
 * backend that is not running, and that is fixable in ten seconds by whoever is
 * looking at the screen. A generic "Something went wrong" is the same as no
 * message.
 */
...
/** The three states in one call, so a page reads as one expression. */
